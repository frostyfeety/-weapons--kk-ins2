...
SWEP.Sounds = {
	...
	base_ready = {
		...
		{time = 25/25, sound = "CW_KK_INS2_NEWSR_BOLTFORWARD"},
	...
	base_fire_end = {
		// shell @ 15 ""},
		{time = 5/30, sound = "CW_KK_INS2_NEWSR_BOLTRELEASE"},
		{time = 10/30, sound = "CW_KK_INS2_NEWSR_BOLTBACK"},
		{time = 15/30, sound = "", callback = shell},
		{time = 20/30, sound = "CW_KK_INS2_NEWSR_BOLTFORWARD"},
		{time = 25/30, sound = "CW_KK_INS2_NEWSR_BOLTLATCH"},
	},
	...
	base_reload = {
		{time = 10/30, sound = "CW_KK_INS2_NEWSR_MAGRELEASE"},
		{time = 23/30, sound = "CW_KK_INS2_NEWSR_MAGOUT"},
		{time = 63/30, sound = "CW_KK_INS2_NEWSR_MAGIN"},
	},
	
	base_reloadempty = {
		{time = 10/25, sound = "CW_KK_INS2_NEWSR_MAGRELEASE"},
		{time = 24/25, sound = "CW_KK_INS2_NEWSR_MAGOUT"},
		{time = 55/25, sound = "CW_KK_INS2_NEWSR_MAGIN"},
		{time = 83/25, sound = "CW_KK_INS2_NEWSR_BOLTRELEASE"},
		{time = 87/25, sound = "CW_KK_INS2_NEWSR_BOLTBACK"},
		{time = 95/25, sound = "CW_KK_INS2_NEWSR_BOLTFORWARD"},
	...
	iron_fire_end = {
		// shell @ 17 ""},
		{time = 3/30, sound = "CW_KK_INS2_NEWSR_BOLTRELEASE"},
		{time = 10/30, sound = "CW_KK_INS2_NEWSR_BOLTBACK"},
		{time = 15/30, sound = "", callback = shell},
		{time = 20/30, sound = "CW_KK_INS2_NEWSR_BOLTFORWARD"},
		{time = 25/30, sound = "CW_KK_INS2_NEWSR_BOLTLATCH"},
