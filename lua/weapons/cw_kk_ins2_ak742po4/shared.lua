...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_optic_rail"] = {model = "models/weapons/upgrades/a_modkit_06.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true,active=true},
		
		["handguardStandard"] = {model = "models/weapons/ethereal/akm742_upgrades/a_standard_ak74.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_optic_rail1"] = {model = "models/weapons/upgrades/w_modkit_6.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true,active=true},
		
		["kk_ins2_pbs5"] = {model = "models/weapons/upgrades/w_sil_ins1.mdl", pos = Vector(-36.25,0.1,11.9), angle = Angle(), size = Vector(1, 1, 1), attachment = "silencer"},
		["handguardStandard"] = {model = "models/weapons/ethereal/akm742_upgrades/a_standard_ak74.mdl", pos = Vector(0.1,0.5,-0), angle = Angle(180,0,-90), size = Vector(1.25, 1.25, 1.25), attachment = "foregrip", active = true},
		...
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(0,-1.03,8.26), angle = Angle(0,180,180), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(0,-1.03,8.26), angle = Angle(0,180,180), size = Vector(1, 1, 1), attachment = "laser"},
	...
	SWEP.IronsightPos = Vector(-0.5449, -2, 0.3504)
...
SWEP.Attachments = {
	{header = "Sight", offset = {400, -450}, atts = {"kk_ins2_po4"}},
...
SWEP.ViewModel		= "models/weapons/ethereal/v_ak742.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_ak742.mdl"

SWEP.WMPos = Vector(4.266, 0.96, -1.055)
