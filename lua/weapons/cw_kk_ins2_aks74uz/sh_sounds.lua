CustomizableWeaponry:addFireSound("CW_KK_INS2_AKS74U_FIRE", "weapons/aks74u/aks_fp.wav")
CustomizableWeaponry:addFireSound("CW_KK_INS2_AKS74U_FIRE_SUPPRESSED", "weapons/cw_kk_ins2_f_ak74/ak74_suppressed_fp.wav")
