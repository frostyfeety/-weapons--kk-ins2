...
if CLIENT then
	...
	["kk_ins2_scope_nam_pso1"] = {model = "models/weapons/upgrades/w_pso1.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true,active=true},
	}
...
SWEP.WMPos = Vector(5.136, 0.786, -1.713)
