...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_fal")
...
SWEP.MuzzleEffect = "muzzleflash_fal"
SWEP.MuzzleEffectWorld = "muzzleflash_fal"

SWEP.Attachments = {
	--{header = "Прицел", offset = {650, -500}, atts = {"kk_ins2_scope_mosin"}},
...
SWEP.WorldModel		= "models/weapons/w_fal.mdl"

SWEP.WMPos = Vector(5.066, 0.86, -1.755)
