...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_f_d_akm")
	
	SWEP.Shell = "KK_INS2_762x39"
	SWEP.ShellDelay = 0.06
	
	SWEP.AttachmentModelsVM = {
		["kk_ins2_pbs1"] = {model = "models/weapons/upgrades/f_pbs1.mdl", pos = Vector(-0.005, 0.175, -0.05), angle = Angle(0, 90, 0), size = Vector(0.65, 0.65, 0.65), attachment = "Suppressor", merge = false},
		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/f_vertgrip_2.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["kk_ins2_gl_gp25"] = {model = "models/weapons/upgrades/f_gl_gp25.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.IronsightPos = Vector(-2.245, 0, 0.85)
...
SWEP.ViewModel		= "models/weapons/v_f_d_akm.mdl"
SWEP.WorldModel		= "models/weapons/w_f_d_akm.mdl"
...
SWEP.FireSound = "CW_KK_INS2_D_AKM_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_D_AKM_FIRE_SUPPRESSED"
SWEP.Recoil = 2.7
