...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_kobra1"] = {model = "models/weapons/upgrades/w_kobra.mdl", pos = Vector(-32.0,0.0,-14.7), angle = Angle(), size = Vector(1, 1, 1), merge = false,active=true},
...
SWEP.HipSpread = 0.03725
SWEP.AimSpread = 0.00225
SWEP.VelocitySensitivity = 1.6
SWEP.MaxSpreadInc = 0.0325
SWEP.SpreadPerShot = 0.00375
SWEP.SpreadCooldown = 0.0725
SWEP.Shots = 1
SWEP.Damage = 75
