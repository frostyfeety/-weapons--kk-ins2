CustomizableWeaponry:addFireSound("CW_KK_INS2_GYURZA_FIRE", "weapons/gyurza/makarov_fp.wav")
CustomizableWeaponry:addFireSound("CW_KK_INS2_GYURZA_FIRE_SUPPRESSED", "weapons/gyurza/makarov_suppressed_fp.wav")
