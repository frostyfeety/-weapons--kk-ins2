...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_m16a4")
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_gl_m2031"] = {model = "models/weapons/upgrades/a_gl_m203.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_gl_m2031"] = {model = "models/weapons/upgrades/w_m203.mdl", attachment = "gl", pos = Vector(-12,1.1,0), angle = Angle(0, 0, -90), size = Vector(1, 1, 1), active = true},
	...
	SWEP.IronsightPos = Vector(-3.8954, -2, 0.9686)
	SWEP.IronsightAng = Vector(-0.2838, 0.05, -30)
...
SWEP.Attachments = {
	{header = "Sight", offset = {500, -500}, atts = {"kk_ins2_cstm_acog"}},
	{header = "Under", offset = {-500, 0}, atts = {"kk_ins2_gl_m203"}},
	}
...
SWEP.WMPos = Vector(4.718, 1.511, -1.243)
