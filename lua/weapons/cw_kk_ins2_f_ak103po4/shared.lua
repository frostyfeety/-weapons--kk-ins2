...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_po4"] = {model = "models/weapons/upgrades/w_po.mdl", pos = Vector(-59.0,-0.3,-6.4), angle = Angle(), size = Vector(1, 1, 1), merge = false},
		["kk_ins2_po41"] = {model = "models/weapons/upgrades/w_po.mdl", pos = Vector(-59.0,-0.3,-6.4), angle = Angle(), size = Vector(1, 1, 1), merge = false,active=true},
