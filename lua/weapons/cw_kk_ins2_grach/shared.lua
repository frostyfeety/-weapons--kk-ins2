...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_suppressor_pistol"] = {model = "models/weapons/upgrades/a_suppressor_pistol.mdl", pos = Vector(-0.3,-0.03,-0.01), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), attachment = "muzzle"},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_suppressor_pistol"] = {model = "models/weapons/upgrades/w_sil_pistol.mdl", pos = Vector(-33.4,0,9.5), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), attachment = "muzzle"},

		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(0.8,8.3,0.25), angle = Angle(180,0,-90), size = Vector(1,1,1), attachment = "Laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(0.8,8.3,0.25), angle = Angle(180,0,-90), size = Vector(1,1,1), attachment = "Laser"},
	}
...
SWEP.MuzzleEffectWorld = "muzzleflash_ots"
...
SWEP.ViewModel		= "models/weapons/ethereal/v_grach.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_grach.mdl"

SWEP.WMPos = Vector(4.509, 1.423, -1.821)
...
SWEP.FireSound = "CW_KK_INS2_GRACH_FIRE"
