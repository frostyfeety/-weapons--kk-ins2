...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_f_d_ak74")
	
	SWEP.Shell = "KK_INS2_545x39"
	SWEP.ShellDelay = 0.06
	
	SWEP.AttachmentModelsVM = {
		["kk_ins2_f_tgpa"] = {model = "models/weapons/upgrades/f_tgpa.mdl", pos = Vector(-2.1, 0.05, -0.025), angle = Angle(0, 0, -90), size = Vector(0.6, 0.6, 0.6), attachment = "muzzle", merge = false},
	...
	SWEP.IronsightPos = Vector(-2.245, 3, 0.73)
	SWEP.IronsightAng = Vector(-0.2, 0.00, 0)
...
SWEP.ViewModel		= "models/weapons/v_f_d_ak74.mdl"
SWEP.WorldModel		= "models/weapons/w_f_d_ak74.mdl"
...
SWEP.FireSound = "CW_KK_INS2_D_AK74_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_D_AK74_FIRE_SUPPRESSED"
SWEP.Recoil = 2.6
