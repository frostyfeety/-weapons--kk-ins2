...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_eo1tech"] = {model = "models/weapons/upgrades/a_optic_eotech_l.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, retSizeMult = 1.2, active = true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_eotec1h"] = {model = "models/weapons/upgrades/w_eotech.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
...
SWEP.Attachments = {
	{header = "Прицел", offset = {400, -450}, atts = {"kk_ins2_eotech"}},
...
SWEP.WMPos = Vector(4.818, 1.411, -1.143)
