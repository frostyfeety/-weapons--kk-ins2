...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_rail"] = {model = "models/weapons/ethereal/ak74z_upgrades/a_modkit_06.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["handguardStandard"] = {model = "models/weapons/ethereal/ak74z_upgrades/a_standard_ak74.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["kk_ins2_pbs5"] = {model = "models/weapons/upgrades/a_suppressor_aks.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},

		["kk_ins2_vertgrip"] = {model = "models/weapons/ethereal/ak74z_upgrades/a_woodgrips_ak74.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_optic_rail"] = {model = "models/weapons/ethereal/ak74z_upgrades/w_modkit_6.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["handguardStandard"] = {model = "models/weapons/ethereal/ak74z_upgrades/w_standard_ak74.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["kk_ins2_pbs5"] = {model = "models/weapons/upgrades/w_sil_ins1.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},

		["kk_ins2_vertgrip"] = {model = "models/weapons/ethereal/ak74z_upgrades/w_foregrip_wood_2.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
...
SWEP.Category = "Soap's SWEPs - Assault Rifles"
...
SWEP.WMPos = Vector(4.666, 0.96, -1.155)
