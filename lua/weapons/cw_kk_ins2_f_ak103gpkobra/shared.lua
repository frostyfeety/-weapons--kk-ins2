...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_f_ak103")
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_pbs1"] = {model = "models/weapons/upgrades/f_pbs1.mdl", pos = Vector(-0.005, 0.45, 0.05), angle = Angle(0, 90, 0), size = Vector(0.65, 0.65, 0.65), attachment = "Suppressor", merge = false},
		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/f_vertgrip_2.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		...
		["kk_ins2_gl_gp251"] = {model = "models/weapons/upgrades/a_gl_gp25.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true,active=true},
		...
		["kk_ins2_kobra"] = {model = "models/weapons/upgrades/a_optic_kobra_l.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, retSizeMult = 1.2,active=true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_gl_gp25"] = {model = "models/weapons/upgrades/w_gp25.mdl", attachment = "gl", pos = Vector(-10.75,0.2,0), angle = Angle(0, 0, -90), size = Vector(1, 1, 1),active=true},
		["kk_ins2_gl_gp251"] = {model = "models/weapons/upgrades/w_gp25.mdl", attachment = "gl", pos = Vector(-10.75,0.2,0), angle = Angle(0, 0, -90), size = Vector(1, 1, 1),active=true},
		...
		["kk_ins2_kobra"] = {model = "models/weapons/upgrades/w_kobra.mdl", pos = Vector(-32, 0, -14.8), angle = Angle(), size = Vector(1, 1, 1), merge = false,active=true},
		["kk_ins2_kobra1"] = {model = "models/weapons/upgrades/w_kobra.mdl", pos = Vector(-32, 0, -14.8), angle = Angle(), size = Vector(1, 1, 1), merge = false,active=true},
...
SWEP.MuzzleEffect = "muzzleflash_ak103"
SWEP.MuzzleEffectWorld = "muzzleflash_ak103"

SWEP.Attachments = {
{header = "Прицел", offset = {400, -450}, atts = {"kk_ins2_kobra"}},
	
	{header = "Подствольник", offset = {-400, 0}, atts = {"kk_ins2_gl_gp25"}},
	
}

SWEP.Animations = {
	base_pickup = "gl_ready",
	base_draw = "gl_draw",
	base_fire = "gl_fire",
...
SWEP.ViewModel		= "models/weapons/v_f_ak103.mdl"
SWEP.WorldModel		= "models/weapons/w_f_ak103.mdl"
