...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_cstm_cmore1"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_cmore.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_cstm_cmore1"] = {model = "models/weapons/attachments/w_cw_kk_ins2_cstm_cmore.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
...
SWEP.Attachments = {
	{header = "Прицел", offset = {400, -450}, atts = {"kk_ins2_cstm_cmore"}},
