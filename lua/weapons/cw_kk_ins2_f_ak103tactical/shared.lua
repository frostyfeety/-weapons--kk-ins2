...
if CLIENT then
	...
	SWEP.PrintName = "AK-103 Tactical"
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/f_vertgrip_2.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true,active=true},
		...
		["kk_ins2_aimpoint1"] = {model = "models/weapons/upgrades/a_optic_aimpoint.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true,active=true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/w_f_vertgrip_2.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true,active=true},
		...
		["kk_ins2_aimpoint"] = {model = "models/weapons/upgrades/w_aimpoint.mdl", pos = Vector(-42, -0.2, -6.3), angle = Angle(), size = Vector(1, 1, 1), merge = false},
		["kk_ins2_aimpoint1"] = {model = "models/weapons/upgrades/w_aimpoint.mdl", pos = Vector(-42, -0.2, -6.3), angle = Angle(), size = Vector(1, 1, 1), merge = false,active=true},
		["kk_ins2_anpeq151"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_anpeq_band.mdl", pos = Vector(16, -0.1, 3.7), angle = Angle(0, 0, -90), size = Vector(1, 1, 1), merge = false,active=true},
	...
	SWEP.IronsightPos = Vector(-3.645, 0, 0.21)
	...
	SWEP.KKINS2AimpointPos = Vector(-2.225, 2, -0.58)
...
SWEP.Attachments = {
	...
	{header = "Лазерок", offset = {200, 400}, atts = {"kk_ins2_anpeq15"}},
