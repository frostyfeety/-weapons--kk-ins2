...
CustomizableWeaponry:addReloadSound("CW_KK_INS2_RPG_LOAD1", "weapons/rpg7/handling/rpg7_load1.wav")
CustomizableWeaponry:addReloadSound("CW_KK_INS2_RPG_LOAD2", "weapons/rpg7/handling/rpg7_load2.wav")

CustomizableWeaponry:addReloadSound("CW_KK_INS2_RPG_PROJECTILE", "weapons/rpg7/rpg_rocket_loop.wav")
